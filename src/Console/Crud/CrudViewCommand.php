...
namespace Orchid\Dashboard\Console\Crud;
...
class CrudViewCommand extends Command
{
    ...
    public function __construct()
    {
        ...
        $this->viewDirectoryPath =  __DIR__ . '/../stubs/crud/';
    }
    ...
    protected function wrapField($item, $field)
    {
        $formGroup =
            ...
            <label for="%1\$s" class="col-sm-3 control-label">%2\$s: </label>
                <div class="col-sm-6">
                    %3\$s
        ...
        $field =
            ...
            <div class="radio">
              <label class="i-checks">
                <input type="radio" name="%1\$s" value="1">
                <i></i>
                Yes
              </label>
            </div>
            <div class="radio">
              <label class="i-checks">
                <input type="radio" name="%1\$s" value="0">
                <i></i>
                No
              </label>
            </div>
